...
Для разворачивания проекта берём всё, что находится в корне biovision-base.
Далее, первым делом надо из папки sample в корне проекта biovision-base скопировать файлы в корень своего проекта (прямо поверх того, что ранее туда скопировал из корня biovision-base).
